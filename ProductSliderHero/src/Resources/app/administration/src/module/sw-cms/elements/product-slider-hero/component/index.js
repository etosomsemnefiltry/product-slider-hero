import template from './sw-cms-el-product-slider-hero.html.twig';
import './sw-cms-el-product-slider-hero.scss';
...
export default {
    ...
    methods: {
        createdComponent() {
            this.initElementConfig('product-slider-hero');
            this.initElementData('product-slider-hero');
        },
